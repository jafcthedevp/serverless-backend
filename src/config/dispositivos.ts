 ...
 */
export const DISPOSITIVOS_CONFIG: Omit<Dispositivo, 'PK' | 'activo' | 'ultima_notificacion'>[] = [
 ...
 */
export function obtenerDispositivoPorCodigo(codigo: string): typeof DISPOSITIVOS_CONFIG[0] | undefined {
  return DISPOSITIVOS_CONFIG.find((d) => d.codigo === codigo);
}

/**
 * Lista todos los códigos de dispositivos
 */
export function listarCodigosDispositivos(): string[] {
  return DISPOSITIVOS_CONFIG.map((d) => d.codigo);
}
