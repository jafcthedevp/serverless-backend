...
class YapeParser {
     ...
     *  03443217"
     */
    static parseNotificacion(texto) {
        try {
     ...
     */
    static extractNombrePagador(texto) {
     ...
     */
    static extractCodigoSeguridad(texto) {
        const patterns = [
     ...
     */
    static parseVoucherTextract(textoExtraido) {
        return {
...
exports.YapeParser = YapeParser;
//# sourceMappingURL=yapeParser.js.map