...
exports.SimilitudService = void 0;
/**
...
class SimilitudService {
     ...
     */
    static calcularSimilitud(nombre1, nombre2) {
     ...
     */
    static calcularSimilitudLevenshtein(str1, str2) {
     ...
     * (usa umbral de 95%)
     */
    static sonSimilares(nombre1, nombre2, umbral = 95) {
        const similitud = this.calcularSimilitud(nombre1, nombre2);
        return similitud >= umbral;
    }
}
exports.SimilitudService = SimilitudService;
