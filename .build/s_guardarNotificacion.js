...
const handlerWrapperArgs = { functionName: 'overshark-backend-dev-guardarNotificacion', timeout: 30 };

try {
  const userHandler = require('./src/handlers/guardarNotificacion.js');
